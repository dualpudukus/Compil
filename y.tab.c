...
{
       1,     2,    12,     1,     2,    14,     2,    38,    10,    17,
       3,    18,     4,     3,    16,    28,    22,    23,    17,    19,
      15,    11,    13,    26,    12,    24,    25,    35,    39,     5,
      36,    41,     5,    40,     5,    30,    31,    32,    33,    20,
      21,    22,    23,    42,    37,    27,    20,    21,    22,    23,
      29,     0,    34,    20,    21,    22,    23
};
...
static const yytype_int8 yycheck[] =
{
      ...
      13,    37,    15,    13,     0,    15,    29,    30,    35,    35,
       5,    32,    23,    32,     3,    10,    11,    33,     4,    32,
      34,    36,    32,    35,    32,    20,    21,    22,    23,    27,
      28,    29,    30,    37,    36,    33,    27,    28,    29,    30,
      17,    -1,    33,    27,    28,    29,    30
};
...
#line 82 "projet.y" /* yacc.c:1646  */
    { 
		  																...
		  																if (symbol_lookup(symbol_table, (yyvsp[-2].string)) == NULL)
		  																	printf("ID not declared.\n");
		  																quad_add(&(yyval.code_expression).code, quad_gen(&next_quad, '=', (yyvsp[0].code_expression).result, NULL, (yyval.code_expression).result));
		  															}
